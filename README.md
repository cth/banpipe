...
BANpipe is based on what was previously called "The LoSt framework", which is available as [banpipe-lost on github](https://github.com/cth/banpipe_lost).
